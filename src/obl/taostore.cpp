...
*/
	void taostore_oram::write_back(std::uint32_t c)
	{
		...
		// duration = (std::clock() - start) / (double)CLOCKS_PER_SEC;
		// std::cout << "update_valid: " << duration << '\n';
