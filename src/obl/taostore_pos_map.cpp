...
namespace obl
{
    ...
    leaf_id taostore_position_map::scan_map(leaf_id *map, int idx, leaf_id replacement, bool to_init, bool fake)
    {
    ...
    leaf_id taostore_position_map::access(block_id bid, bool fake, leaf_id *_ev_leef)
    {
