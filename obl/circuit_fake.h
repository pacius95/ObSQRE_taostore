...
// content of the ORAM
	...
	public:
		...
		void access_r(block_id bid, leaf_id lif, std::uint8_t *data_out, bool fake);
		void access_w(block_id bid, leaf_id lif, std::uint8_t *data_in, leaf_id next_lif, bool fake);
